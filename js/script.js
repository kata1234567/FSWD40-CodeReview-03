function calculateInsurance() {
    ...
    if (age >= 85 || age <=17) {
        ...
        document.getElementById("output").innerHTML = "Dear " + name + ", your insurance costs are " + Math.round(result) + " €. <br>Because of your " + power + " kW HP car model " + car + " and your age of " + age + ".";
